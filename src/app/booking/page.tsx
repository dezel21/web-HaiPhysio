...
import Step3IsiData from "../../components/booking/Step3IsiData"; // <-- Pastikan import ini ada
      ...
      <div className="relative z-10 w-full max-w-[1200px] mx-auto bg-white rounded-[32px] p-6 md:p-12 shadow-[0_8px_40px_rgba(0,0,0,0.04)]">
        ...
        {currentStep === 4 && (
          <div className="w-full flex flex-col items-center pt-20">
            <h2 className="text-2xl font-bold">Ini komponen Step 4 (Konfirmasi)</h2>
            <button onClick={() => setCurrentStep(3)} className="mt-4 px-4 py-2 border rounded">Kembali ke Step 3</button>
          </div>
        )}
