...
export default function KontakKami() {
  ...
  return (
    <div className="w-full flex flex-col min-h-screen">
        ...
        <div className="w-full max-w-[1440px] mx-auto px-5 md:px-[80px] flex flex-col gap-10">
          ...
          <div className="flex flex-col items-center text-center gap-3">
            ...
            <p className="text-[#585858] text-[16px] max-w-[600px]">
              Hubungi kami lewat WhatsApp atau Email, atau langsung datang ke klinik.
            </p>
          </div>

          {/* Grid Cards (Copy-paste dari Beranda) */}
      ...
      {/* 3. SECTION LOKASI KLINIK (Copy-paste dari Beranda) */}
